...
<div id="right">
  ...
  <div id="bottom">
  	<div>
  		<iframe scrolling="no" src="ccdcc/hiscar3.html?branchId=${param.branchId }&proId=${param.proId }&sid=${param.sid }&time1=${param.t1 }&time2=${param.t2 }" width=100% height="630"  frameborder=0></iframe >
	<div>
  </div>
</div>
<div class="clear"></div>

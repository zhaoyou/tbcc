...
<script type="text/javascript">
	...
	function golist(url,operate){
	 ...
	 var mapobj = null;				//地图对象
			...
			//经纬度信息
			var lng = 121.550902  ; // 公司经度dbtype:12135.37846 		
			var lat = 31.235708  ; // 公司纬度 dbtype:3114.90598 
...
<div id="right">
  <div id="top"><a href="#"><img src="images/canku/icon_c.gif" width="16" height="15"  class="tb4"/><strong>位置:</strong>您正在查看车载实时数据地图显示</a>

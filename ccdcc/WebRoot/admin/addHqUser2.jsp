  ...
  <div id="bottom">
    <fieldset id="login">
      ...
      <table width="418" style="border:0;">
        ...
        <tr>
          <td height="22" valign="top" ><label for="label">选择角色：</label></td>
          <td>
        ...
        <tr>
          ...
          <td><div>
              ...
              <input type="button" value="返回"  class="input_aa"  onclick="javascript:window.location.href='configHqUser.do?ope=forwordConfigHqUser'" />
            </div></td>
          <td>
				&nbsp;
		</td>

...
<title>${fdaporg.name }车载历史轨迹回放</title>
...
<div id="content">
  <div id="center" style="height: 600px;">
    <div class="top">
      <table id="tb" border="0" cellspacing="0" cellpadding="0" >
        <tr id="tb1" >
          ...
          <img src=images/index/icon.gif width="9" height="10" /> 当前位置：查看${fdaporg.name }的车载历史轨迹回放</span>
    ...
    <div class="bottom"	style="padding-top:0px; margin-top:0px;">
      	<iframe scrolling="no" src="http://www.thermoberg.com/ccdcc/map/fdap_customer_hismap.jsp?projectId=${pNO }&beginTime=${startTime }" width=100% height=540 frameborder=0></iframe >

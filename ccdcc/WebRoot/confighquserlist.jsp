...
<div id="right">
  ...
  <strong>位置:首页</strong>&lt;总部用户配置</a>
 	</div>
  <div id="center">
    <div>用户列表</div>
  </div>
  <div id="bottom">
    <table width="70%" border="0" align="center" cellpadding="0" cellspacing="0" id="tb">
      <tr id="tb22">
        <td width="53">请复选</td>
        <td width="97">用户名</td>
        <td width="111">密码</td>
      ...
      <tr>
        ...
        <div id="center">
    <div>
    <img src="images/admin/an0060.gif" width="45" height="19" style="cursor: pointer;" onclick="javascript:window.location.href='configHqUser.do?ope=forwordAddHqUser'" />

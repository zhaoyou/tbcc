      ...
      <c:forEach var="startup" items="${startList}" varStatus="i">
      			<tr ${i.count%2==0?"class='altrow'":"" }>
					...
					<td>
        				...
        				<img  src="img/menu/alarm.png" title="车载历史报警"  style="cursor:pointer;display:${fn:contains(power,"车载历史报警")==true?'inline':'none'} " onclick="javascript:godetail('hiscaralarm.do','toHisCarAlarm',${startup.id },true);"/>
        	 		</td>
					</tr>
	  </c:forEach>

  ...
  <div id="center" >
    <div class="top" style="display:block;">
      <table id="tb" border="0" cellspacing="0" cellpadding="0" >
        <tr id="tb1" >
          <td colspan="7"><span style="text-align:left; float:left;padding-left:4px; margin-left:4px; color:#141414;"><img src=../images/admin/index/icon.gif width="9" height="10" /> 你当前所在位置为： 顶级机构系统管理员信息配置</span></td>
        </tr>
      </table>
    </div>
    <div class="bottom">
      <div class="con_center">
        <form action="userconfig.do" method="post" id="myform" name="myform">
  			<input type="hidden" id="ope" name="ope" value="doSysadmin"/>
          <p>
            <label for="fdsafa">用户名：</label>
            <input id="sysadminname" name="sysadminname" style="background-color: #f1f4f8;" readonly="readonly" type="textfield" value="${sysadminname }" class="input_a"/><span></span>
          </p>
          <p>

           ...
           */
            ...
            */
            function mapInit(){
                ...
                //验证参数是否存在
                if(document.getElementById("proId").value=="" || document.getElementById("sid").value==""){
                	return ;
                }
...
<body onload="mapInit();" oncontextmenu="window.event.returnValue=false" >
<form action="startup.do" method="post" name="myform" id="myform">	
	<input type="hidden" id="proId" name="proId" value="${param.projectId }"/>
  ...
  <div id="center">
    <table width="78%" id="bd3">
      <tr>
        ...
        <td width="140"><input type="text" class="input" name="projectName"   id="projectName" value="${projectName }"  style="text-align: center;" readonly="readonly"/></td>

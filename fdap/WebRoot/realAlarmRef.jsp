...
<title>${fdaporg.name }仓库实时报警页面</title>
    ...
    <div class="top" style="position:relative; display:block;">
      <table id="tb" border="0" cellspacing="0" cellpadding="0" >
        <tr id="tb1" >
          ...
          <img src=images/index/icon.gif width="9" height="10" /> 当前位置： 查看${fdaporg.name }仓库实时报警页面</span>
      ...
      <table id="tb" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <table width="100%" style="height:35px;">
            <tr>
              <td width="110" style="border:none;"><a href="javascript:;"><img src="images/index/alarm_b.gif" width="100" height="24" /></a></td>

...
.STYLE2 {color: #454343}
	...
	<script type="text/javascript">
			...
			*/
			...
			function isAllOK(){		
				 if( mul_flag && comdenser_flag && compress_flag && aircooler_flag)
			...
			*/
			function getCompressorData(){
				...
				function getCompressoilAlarm(data){
				...
				if(data!=null){
					if(data.length>0){
						...
						for(; i<data.length;i++){
							...
							document.getElementById('compressoroil_'+i).innerHTML = getCompressoil(r);
							document.getElementById('compressoroilalarm_'+i).innerHTML = getCompressoilAlarm(r);
...
<div id="top"><a href="#"><img src="images/Refri/icon_c.gif" width="16" height="15"  class="tb4"/><strong>位置:首页</strong>&lt;并联机组实时数据查看</a><span>
...
<span id="net" style="color: red;display: none">获取制冷实时数据失败,请稍后....</span>
  ...
  <div id="bottom">
    ...
    <table id="tb" width="78%" border="0" cellspacing="0" cellpadding="0">
          <tr id="tb1">
            <td width="6%">&nbsp;</td>
            <td width="25%">监测点</td><td width="32%">状态</td>
            <td width="37%">预警</td>
          </tr>
          <tr class="tb2">
    ...
    <table id="tb" width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr class="tb2">
            <td><span class="orr"><img src="images/Refri/icon.gif" ></img></span></td>
            <td>油压保护</td>
            <td><div id="compressoroil_0"></div></td>
            <td><div id="compressoroilalarm_0"></div></td>
            <td><div id="compressoroil_1"></div></td>
            <td><div id="compressoroilalarm_1"></div></td>
            <td><div id="compressoroil_2"></div></td>
            <td><div id="compressoroilalarm_2"></div></td>
            <td><div id="compressoroil_3"></div></td>
            <td><div id="compressoroilalarm_3"></div></td>
            <td><div id="compressoroil_4"></div></td>
            <td><div id="compressoroilalarm_4"></div></td>
            <td><div id="compressoroil_5"></div></td>
            <td><div id="compressoroilalarm_5"></div></td>
          </tr>
    </table>
    </div>

	...
	<script type="text/javascript">
		...
		**/
			...
			*/
			function doCoolerSystem(data){
				if(data!=null){
					...
					document.getElementById("xitongduandian").innerHTML = getFadianjiState(data.sysoutageState);
		...
		/**
			...
			*	系统发电机的状态
			**/
			function getFadianjiState(state){
				if(state==2){
					return "断电" ;
				}else if(state==1){
					return "供电" ;
...
<div id="right" style="background-color: white"><table width="100%" border="0" cellpadding="0" cellspacing="0" >
  <tr>
      ...
      <tr>
        <td colspan="4"><table width="280" align="left" class="datalist2">
          <tr>
            ...
            <th width="89" scope="col">监测点</th>
            <th width="58" scope="col">状态</th>
            <th width="88" scope="col">预警</th>
          </tr>
          <tr>
            <td><img src="images/Refri/quexiang.png"></img></td>
            <td>系统断电</td>
            <td><div id="xitongduandian">----</div>							

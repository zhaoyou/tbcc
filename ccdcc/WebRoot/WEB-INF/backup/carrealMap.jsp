...
<html>
  <head>
    ...
    <title>移动车载实时数据地图展示...</title>
    
	<meta http-equiv="pragma" content="no-cache">
	<meta http-equiv="cache-control" content="no-cache">
	<meta http-equiv="expires" content="0">    
	<meta http-equiv="keywords" content="keyword1,keyword2,keyword3">
	<meta http-equiv="description" content="车载实时数据地图显示">
		...
		<script type="text/javascript" src="script/titleTime.js"></script>
		 <script type="text/javascript" src="http://app.mapabc.com/apis?&t=flashmap&v=2.3.1&key=de69148208cf12939f72a018a26b8423aa23752271a878349d006460faafca20f1b818ea84ebb9a6">
        </script>
        <script type="text/javascript">
			...
			//经纬度信息
			var lng = 121.589641  ; // 公司经度dbtype:12135.37846 (121.596923 建银大厦)			
			var lat = 31.248433  ; // 公司纬度 dbtype:3114.90598 (31.255061 建银大厦)
			
			//定义地图当前的经纬度信息
			var current_lng =	121.589641 ;  	//公司经度   (121.596923 建银)
			var current_lat =   31.248433 	 ;	//公司纬度  	(31.255061 建银)
  ...
  <form name="myform" action="realcar.do?ope=toRealMap" method="post">
	     ...
	     <tr>
				<td width="990" height="550" colspan="3" valign="top"
					background="img/stock_index_08.gif">
						...
						<div class="page_title">您正在做的业务是：<img src="img/add/club.JPG" alt=">>"><font size="2px">&nbsp;车载实时数据地图显示</font>&nbsp;&nbsp;&nbsp;  
						<button class="common_button" type="button" onclick="javascript:window.location.href='realcar.do?ope=toRealData&branchId=${param.branchId }'">返回</button>
						<div id="mytest"></div>
						</div>	
					<table >
					 	<tr>
                        ...
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  <b>当前车载连接状态:</b><span id="connectioninfo"><font color='red'> 断 开 </font></span>  
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  <b>当前车载运行状态:</b><span id="runinfo"><font color='red'> 停 止 </font></span>  
                        ...
                        <tr>
                        	<td >
                        	 <div id="map" class="view" style="width: 990px; height: 510px;border: solid;border-color: gray">
              				  </div>
                        	</td>
                        </tr>
					</table>

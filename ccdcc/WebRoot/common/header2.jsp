...
<div id="head">
   <div id="banner"><ul>
    ...
    <li class="nav_a" style="display: ${sessionScope.hqId==null?'none':'inline' }"><a href="../user.do?ope=doHqLogout" target="_parent"></a></li>
   ...
   <span id="time"></span>  <a href="../help/help/refreal.html" target="_blank"><img src="../images/head/help-128x128.png" height="15" width="15" style="border: none;"  />系统帮助</a>  </div>
</div><!--head end-->
</body>
</html>

 ...
 <link href="css/style.css" rel="stylesheet" type="text/css">
		...
		<script type="text/javascript">
			...
			*/
			...
			//	window.alert("sys_flag: "+sys_flag) ;
			//	window.alert("single_flag: "+single_flag) ;
			//	window.alert("comdenser_flag: "+comdenser_flag) ;
			//	window.alert("compress_flag: "+ compress_flag) ;
			//	window.alert("aircooler_flag: "+ aircooler_flag) ;
				
				 if(sys_flag && single_flag && comdenser_flag && compress_flag && aircooler_flag)
				...
				<tr>
					<td width="990" height="550" colspan="3" valign="top"
						...
						<div id="main" style="width: 990px; height: 100%; float: left">
							...
							请选择查看的机组名称:
							<select name="mysetid" id="mysetid" style="width: 150px" onchange="changeValue(this);">
							...
							<table width="990" id="tableContainer">
								...
								<thead>	
								  <tr valign='top' HEIGHT='20' bgcolor='#DEDEDE' CLASS=Page_tools_bar>
								 	 ...
								 	 <td align='center' CLASS=Page_title valign='middle'>缺项预警</td>
								 	 <td align='center' CLASS=Page_title valign='middle'>过载保护</td>
								 	 <td align='center' CLASS=Page_title valign='middle'>过载预警</td>
								 	  <td align='center' CLASS=Page_title valign='middle'>故障保护</td>
								 	  <td align='center' CLASS=Page_title valign='middle'>故障预警</td>
							      </tr>
								</thead>
									<tbody id="container">
										<tr align="center">
											<td>${compressorset.csName }</td>
											<td>${noMsg eq null?"冷凝机组":"" } </td>
								...
								<thead>	
								  <tr valign='top' HEIGHT='20' bgcolor='#DEDEDE' CLASS=Page_tools_bar>
								 	 ...
								 	 <td align='center' CLASS=Page_title valign='middle'>排气预警</td>
								 	  <!-- 
								 	 <td align='center' CLASS=Page_title valign='middle'>断电保护</td>
								 	 <td align='center' CLASS=Page_title valign='middle'>断电预警</td>
								 	  -->
								 	 <td align='center' CLASS=Page_title valign='middle'>过载保护</td>
								 	 <td align='center' CLASS=Page_title valign='middle'>过载预警</td>

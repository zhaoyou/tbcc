...
<div id="right">
  <div id="center">
    <table width="95%" id="bd3">
      <tr>
        <td width="10%"><h3 style="color:#454343; font-size:12px;  width:120px;">当前选择的车载是：</h3></td>
  ...
  <div id="bottom">
	<div id="map" class="view" style="width: 985px; height: 510px;"></div>
  </div>
  
</div>
<form id="myform" name="myform" action="" method="post">
 <input type="hidden" name="myinterval" id="myinterval" value="10000"/>
 <input type="hidden" name="proId" id="proId" value="${param.projectId }"/>

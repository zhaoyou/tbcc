			...
			[
				...
				function(data){
					if(data.connectStatus==null || data.connectStatus==1){
						...
						if(data.unloadStatus==-1){
							return "--";
						}
						else if(data.unloadStatus==1){
							return "运输";
						}else{
...
<form action="" name="myform" id="myform" method="post">
    ...
    <input type="hidden" name="p" id="p" value="true" />
    <input type="hidden" name="exeget"  id="exeget"  value="${exeget }"/>
</form>
<div id="right">
  <div id="top" align="center"><a href="#"><img src="images/chezai/icon_c.gif" width="16" height="15" class="tb4"/>
  	<strong>位置:</strong>您正在查看车载实时数据</a>
  </div>
  <div align="center">
